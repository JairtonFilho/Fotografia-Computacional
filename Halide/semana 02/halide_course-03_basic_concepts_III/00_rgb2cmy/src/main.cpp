...
#include "rgb2cmy_update.h"
#include "rgb2cmy_select.h"
#include "rgb2cmy_mux.h"
...
int main(int argc, char ** argv) {
    ...
    rgb2cmy_update(input, output_update);
    rgb2cmy_select(input, output_select);
    rgb2cmy_mux(input, output_mux);
